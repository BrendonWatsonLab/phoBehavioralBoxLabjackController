...
#define globalLabjackInputPortType {LabjackPortType::Analog, LabjackPortType::Analog, LabjackPortType::Analog, LabjackPortType::Analog, LabjackPortType::DigitalState};
...
#define globalLabjackDigitalInputPortType {LabjackPortType::DigitalState}
